...
g[h].split(""),q=0;3>q;q++)if("0"===f[0]&&1<f.length)f.splice(0,1);else break;g[h]=f.join("")}var f=-1,t=q=0,r=-1,x=!1;for(h=0;h<b;h++)x?"0"===g[h]?t+=1:(x=!1,t>q&&(f=r,q=t)):"0"==g[h]&&(x=!0,r=h,t=1);t>q&&(f=r,q=t);1<q&&g.splice(f,q,"");f=g.length;b="";""===g[0]&&(beststr=":");for(h=0;h<f;h++){b+=g[h];if(h===f-1)break;b+=":"}""===g[f-1]&&(b+=":");return b},noConflict:function(){f.IPv6===this&&(f.IPv6=h);return this}}});
(function(f){function h(a){throw RangeError(B[a]);}function g(a,c){for(var d=a.length;d--;)a[d]=c(a[d]);return a}function n(a,c){return g(a.split(m),c).join(".")}function b(a){for(var c=[],d=0,b=a.length,m,e;d<b;)m=a.charCodeAt(d++),55296<=m&&56319>=m&&d<b?(e=a.charCodeAt(d++),56320==(e&64512)?c.push(((m&1023)<<10)+(e&1023)+65536):(c.push(m),d--)):c.push(m);return c}function v(a){return g(a,function(a){var c="";65535<a&&(a-=65536,c+=C(a>>>10&1023|55296),a=56320|a&1023);return c+=C(a)}).join("")}function q(a,
c){return a+22+75*(26>a)-((0!=c)<<5)}function t(a,c,d){var b=0;a=d?A(a/G):a>>1;for(a+=A(a/c);a>u*y>>1;b+=l)a=A(a/u);return A(b+(u+1)*a/(a+H))}function r(c){var d=[],b=c.length,m,e=0,B=D,f=E,k,r,g,u,s;k=c.lastIndexOf(a);0>k&&(k=0);for(r=0;r<k;++r)128<=c.charCodeAt(r)&&h("not-basic"),d.push(c.charCodeAt(r));for(k=0<k?k+1:0;k<b;){r=e;m=1;for(g=l;;g+=l){k>=b&&h("invalid-input");u=c.charCodeAt(k++);u=10>u-48?u-22:26>u-65?u-65:26>u-97?u-97:l;(u>=l||u>A((p-e)/m))&&h("overflow");e+=u*m;s=g<=f?w:g>=f+y?y:
g-f;if(u<s)break;u=l-s;m>A(p/u)&&h("overflow");m*=u}m=d.length+1;f=t(e-r,m,0==r);A(e/m)>p-B&&h("overflow");B+=A(e/m);e%=m;d.splice(e++,0,B)}return v(d)}function x(c){var d,m,e,B,k,f,r,u,g,s=[],x,z,n;c=b(c);x=c.length;d=D;m=0;k=E;for(f=0;f<x;++f)g=c[f],128>g&&s.push(C(g));for((e=B=s.length)&&s.push(a);e<x;){r=p;for(f=0;f<x;++f)g=c[f],g>=d&&g<r&&(r=g);z=e+1;r-d>A((p-m)/z)&&h("overflow");m+=(r-d)*z;d=r;for(f=0;f<x;++f)if(g=c[f],g<d&&++m>p&&h("overflow"),g==d){u=m;for(r=l;;r+=l){g=r<=k?w:r>=k+y?y:r-k;
if(u<g)break;n=u-g;u=l-g;s.push(C(q(g+n%u,0)));u=A(n/u)}s.push(C(q(u,0)));k=t(m,z,e==B);m=0;++e}++m;++d}return s.join("")}var z="object"==typeof exports&&exports,k="object"==typeof module&&module&&module.exports==z&&module,s="object"==typeof global&&global;if(s.global===s||s.window===s)f=s;var e,p=2147483647,l=36,w=1,y=26,H=38,G=700,E=72,D=128,a="-",c=/^xn--/,d=/[^ -~]/,m=/\x2E|\u3002|\uFF0E|\uFF61/g,B={overflow:"Overflow: input needs wider integers to process","not-basic":"Illegal input >= 0x80 (not a basic code point)",
"invalid-input":"Invalid input"},u=l-w,A=Math.floor,C=String.fromCharCode,F;e={version:"1.2.3",ucs2:{decode:b,encode:v},decode:r,encode:x,toASCII:function(a){return n(a,function(a){return d.test(a)?"xn--"+x(a):a})},toUnicode:function(a){return n(a,function(a){return c.test(a)?r(a.slice(4).toLowerCase()):a})}};if("function"==typeof define&&"object"==typeof define.amd&&define.amd)define(function(){return e});else if(z&&!z.nodeType)if(k)k.exports=e;else for(F in e)e.hasOwnProperty(F)&&(z[F]=e[F]);else f.punycode=
e})(this);
...
var l={encode:"encode",decode:"decode"},w,y=function(a,c){return function(d){return b[c](d+"").replace(b.characters[a][c].expression,function(d){return b.characters[a][c].map[d]})}};for(w in l)b[w+"PathSegment"]=y("pathname",l[w]);b.encodeReserved=y("reserved","encode");b.parse=function(a,c){var d;c||(c={});d=a.indexOf("#");-1<d&&(c.fragment=a.substring(d+1)||null,a=a.substring(0,d));d=a.indexOf("?");-1<d&&(c.query=a.substring(d+1)||null,a=a.substring(0,d));"//"===a.substring(0,2)?(c.protocol=null,
...
null):a.indexOf(":")!==a.lastIndexOf(":")?(c.hostname=a.substring(0,d)||null,c.port=null):(b=a.substring(0,d).split(":"),c.hostname=b[0]||null,c.port=b[1]||null);c.hostname&&"/"!==a.substring(d).charAt(0)&&(d++,a="/"+a);return a.substring(d)||"/"};b.parseAuthority=function(a,c){a=b.parseUserinfo(a,c);return b.parseHost(a,c)};b.parseUserinfo=function(a,c){var d=a.indexOf("/"),m=-1<d?a.lastIndexOf("@",d):a.indexOf("@");-1<m&&(-1===d||m<d)?(d=a.substring(0,m).split(":"),c.username=d[0]?b.decode(d[0]):
null,d.shift(),c.password=d[0]?b.decode(d.join(":")):null,a=a.substring(m+1)):(c.username=null,c.password=null);return a};b.parseQuery=function(a,c){if(!a)return{};a=a.replace(/&+/g,"&").replace(/^\?*&*|&+$/g,"");if(!a)return{};for(var d={},m=a.split("&"),e=m.length,f,k,r=0;r<e;r++)f=m[r].split("="),k=b.decodeQuery(f.shift(),c),f=f.length?b.decodeQuery(f.join("="),c):null,d[k]?("string"===typeof d[k]&&(d[k]=[d[k]]),d[k].push(f)):d[k]=f;return d};b.build=function(a){var c="";a.protocol&&(c+=a.protocol+
":");a.urn||!c&&!a.hostname||(c+="//");c+=b.buildAuthority(a)||"";"string"===typeof a.path&&("/"!==a.path.charAt(0)&&"string"===typeof a.hostname&&(c+="/"),c+=a.path);"string"===typeof a.query&&a.query&&(c+="?"+a.query);"string"===typeof a.fragment&&a.fragment&&(c+="#"+a.fragment);return c};b.buildHost=function(a){var c="";if(a.hostname)b.ip6_expression.test(a.hostname)?c=a.port?c+("["+a.hostname+"]:"+a.port):c+a.hostname:(c+=a.hostname,a.port&&(c+=":"+a.port));else return"";return c};b.buildAuthority=
function(a){return b.buildUserinfo(a)+b.buildHost(a)};b.buildUserinfo=function(a){var c="";a.username&&(c+=b.encode(a.username),a.password&&(c+=":"+b.encode(a.password)),c+="@");return c};b.buildQuery=function(a,c,d){var m="",e,f,k,r;for(f in a)if(p.call(a,f)&&f)if(t(a[f]))for(e={},k=0,r=a[f].length;k<r;k++)void 0!==a[f][k]&&void 0===e[a[f][k]+""]&&(m+="&"+b.buildQueryParameter(f,a[f][k],d),!0!==c&&(e[a[f][k]+""]=!0));else void 0!==a[f]&&(m+="&"+b.buildQueryParameter(f,a[f],d));return m.substring(1)};
...
else if("object"===typeof c)for(m in c)p.call(c,m)&&b.removeQuery(a,m,c[m]);else if("string"===typeof c)if(void 0!==d)if(a[c]===d)a[c]=void 0;else{if(t(a[c])){m=a[c];var e={},f,k;if(t(d))for(f=0,k=d.length;f<k;f++)e[d[f]]=!0;else e[d]=!0;f=0;for(k=m.length;f<k;f++)void 0!==e[m[f]]&&(m.splice(f,1),k--,f--);a[c]=m}}else a[c]=void 0;else throw new TypeError("URI.addQuery() accepts an object, string as the first parameter");};b.hasQuery=function(a,c,d,m){if("object"===typeof c){for(var e in c)if(p.call(c,
e)&&!b.hasQuery(a,e,c[e]))return!1;return!0}if("string"!==typeof c)throw new TypeError("URI.hasQuery() accepts an object, string as the name parameter");switch(q(d)){case "Undefined":return c in a;case "Boolean":return a=Boolean(t(a[c])?a[c].length:a[c]),d===a;case "Function":return!!d(a[c],c,a);case "Array":return t(a[c])?(m?r:x)(a[c],d):!1;case "RegExp":return t(a[c])?m?r(a[c],d):!1:Boolean(a[c]&&a[c].match(d));case "Number":d=String(d);case "String":return t(a[c])?m?r(a[c],d):!1:a[c]===d;default:throw new TypeError("URI.hasQuery() accepts undefined, boolean, string, number, RegExp, Function as the value parameter");
}};b.commonPath=function(a,c){var d=Math.min(a.length,c.length),b;for(b=0;b<d;b++)if(a.charAt(b)!==c.charAt(b)){b--;break}if(1>b)return a.charAt(0)===c.charAt(0)&&"/"===a.charAt(0)?"/":"";if("/"!==a.charAt(b)||"/"!==c.charAt(b))b=a.substring(0,b).lastIndexOf("/");return a.substring(0,b+1)};b.withinString=function(a,c,d){d||(d={});var e=d.start||b.findUri.start,f=d.end||b.findUri.end,k=d.trim||b.findUri.trim,r=/[a-z0-9-]=["']?$/i;for(e.lastIndex=0;;){var g=e.exec(a);if(!g)break;g=g.index;if(d.ignoreHtml){var s=
a.slice(Math.max(g-3,0),g);if(s&&r.test(s))continue}var s=g+a.slice(g).search(f),h=a.slice(g,s).replace(k,"");d.ignore&&d.ignore.test(h)||(s=g+h.length,h=c(h,g,s,a),a=a.slice(0,g)+h+a.slice(s),e.lastIndex=g+h.length)}e.lastIndex=0;return a};b.ensureValidHostname=function(a){if(a.match(b.invalid_hostname_characters)){if(!f)throw new TypeError("Hostname '"+a+"' contains characters other than [A-Z0-9.-] and Punycode.js is not available");if(f.toASCII(a).match(b.invalid_hostname_characters))throw new TypeError("Hostname '"+
a+"' contains characters other than [A-Z0-9.-]");}};b.noConflict=function(a){if(a)return a={URI:this.noConflict()},URITemplate&&"function"==typeof URITemplate.noConflict&&(a.URITemplate=URITemplate.noConflict()),h&&"function"==typeof h.noConflict&&(a.IPv6=h.noConflict()),SecondLevelDomains&&"function"==typeof SecondLevelDomains.noConflict&&(a.SecondLevelDomains=SecondLevelDomains.noConflict()),a;n.URI===this&&(n.URI=s);return this};e.build=function(a){if(!0===a)this._deferred_build=!0;else if(void 0===
a||this._deferred_build)this._string=b.build(this._parts),this._deferred_build=!1;return this};e.clone=function(){return new b(this)};e.valueOf=e.toString=function(){return this.build(!1)._string};l={protocol:"protocol",username:"username",password:"password",hostname:"hostname",port:"port"};y=function(a){return function(c,d){if(void 0===c)return this._parts[a]||"";this._parts[a]=c||null;this.build(!d);return this}};for(w in l)e[w]=y(l[w]);l={query:"?",fragment:"#"};y=function(a,c){return function(d,
b){if(void 0===d)return this._parts[a]||"";null!==d&&(d+="",d.charAt(0)===c&&(d=d.substring(1)));this._parts[a]=d;this.build(!b);return this}};for(w in l)e[w]=y(w,l[w]);l={search:["?","query"],hash:["#","fragment"]};y=function(a,c){return function(d,b){var e=this[a](d,b);return"string"===typeof e&&e.length?c+e:e}};for(w in l)e[w]=y(l[w][1],l[w][0]);e.pathname=function(a,c){if(void 0===a||!0===a){var d=this._parts.path||(this._parts.hostname?"/":"");return a?b.decodePath(d):d}this._parts.path=a?b.recodePath(a):
"/";this.build(!c);return this};e.path=e.pathname;e.href=function(a,c){var d;if(void 0===a)return this.toString();this._string="";this._parts=b._parts();var e=a instanceof b,f="object"===typeof a&&(a.hostname||a.path||a.pathname);a.nodeName&&(f=b.getDomAttribute(a),a=a[f]||"",f=!1);!e&&f&&void 0!==a.pathname&&(a=a.toString());if("string"===typeof a)this._parts=b.parse(a,this._parts);else if(e||f)for(d in e=e?a._parts:a,e)p.call(this._parts,d)&&(this._parts[d]=e[d]);else throw new TypeError("invalid input");
this.build(!c);return this};e.is=function(a){var c=!1,d=!1,e=!1,f=!1,k=!1,r=!1,s=!1,h=!this._parts.urn;this._parts.hostname&&(h=!1,d=b.ip4_expression.test(this._parts.hostname),e=b.ip6_expression.test(this._parts.hostname),c=d||e,k=(f=!c)&&g&&g.has(this._parts.hostname),r=f&&b.idn_expression.test(this._parts.hostname),s=f&&b.punycode_expression.test(this._parts.hostname));switch(a.toLowerCase()){case "relative":return h;case "absolute":return!h;case "domain":case "name":return f;case "sld":return k;
case "ip":return c;case "ip4":case "ipv4":case "inet4":return d;case "ip6":case "ipv6":case "inet6":return e;case "idn":return r;case "url":return!this._parts.urn;case "urn":return!!this._parts.urn;case "punycode":return s}return null};var H=e.protocol,G=e.port,E=e.hostname;e.protocol=function(a,c){if(void 0!==a&&a&&(a=a.replace(/:(\/\/)?$/,""),!a.match(b.protocol_expression)))throw new TypeError("Protocol '"+a+"' contains characters other than [A-Z0-9.+-] or doesn't start with [A-Z]");return H.call(this,
...
1;return this._parts.hostname.substring(0,d)||""}d=this._parts.hostname.length-this.domain().length;d=this._parts.hostname.substring(0,d);d=RegExp("^"+v(d));a&&"."!==a.charAt(a.length-1)&&(a+=".");a&&b.ensureValidHostname(a);this._parts.hostname=this._parts.hostname.replace(d,a);this.build(!c);return this};e.domain=function(a,c){if(this._parts.urn)return void 0===a?"":this;"boolean"===typeof a&&(c=a,a=void 0);if(void 0===a){if(!this._parts.hostname||this.is("IP"))return"";var d=this._parts.hostname.match(/\./g);
if(d&&2>d.length)return this._parts.hostname;d=this._parts.hostname.length-this.tld(c).length-1;d=this._parts.hostname.lastIndexOf(".",d-1)+1;return this._parts.hostname.substring(d)||""}if(!a)throw new TypeError("cannot set domain empty");b.ensureValidHostname(a);!this._parts.hostname||this.is("IP")?this._parts.hostname=a:(d=RegExp(v(this.domain())+"$"),this._parts.hostname=this._parts.hostname.replace(d,a));this.build(!c);return this};e.tld=function(a,c){if(this._parts.urn)return void 0===a?"":
this;"boolean"===typeof a&&(c=a,a=void 0);if(void 0===a){if(!this._parts.hostname||this.is("IP"))return"";var d=this._parts.hostname.lastIndexOf("."),d=this._parts.hostname.substring(d+1);return!0!==c&&g&&g.list[d.toLowerCase()]?g.get(this._parts.hostname)||d:d}if(a)if(a.match(/[^a-zA-Z0-9-]/))if(g&&g.is(a))d=RegExp(v(this.tld())+"$"),this._parts.hostname=this._parts.hostname.replace(d,a);else throw new TypeError("TLD '"+a+"' contains characters other than [A-Z0-9]");else{if(!this._parts.hostname||
this.is("IP"))throw new ReferenceError("cannot set TLD on non-domain host");d=RegExp(v(this.tld())+"$");this._parts.hostname=this._parts.hostname.replace(d,a)}else throw new TypeError("cannot set TLD empty");this.build(!c);return this};e.directory=function(a,c){if(this._parts.urn)return void 0===a?"":this;if(void 0===a||!0===a){if(!this._parts.path&&!this._parts.hostname)return"";if("/"===this._parts.path)return"/";var d=this._parts.path.length-this.filename().length-1,d=this._parts.path.substring(0,
d)||(this._parts.hostname?"/":"");return a?b.decodePath(d):d}d=this._parts.path.length-this.filename().length;d=this._parts.path.substring(0,d);d=RegExp("^"+v(d));this.is("relative")||(a||(a="/"),"/"!==a.charAt(0)&&(a="/"+a));a&&"/"!==a.charAt(a.length-1)&&(a+="/");a=b.recodePath(a);this._parts.path=this._parts.path.replace(d,a);this.build(!c);return this};e.filename=function(a,c){if(this._parts.urn)return void 0===a?"":this;if(void 0===a||!0===a){if(!this._parts.path||"/"===this._parts.path)return"";
var d=this._parts.path.lastIndexOf("/"),d=this._parts.path.substring(d+1);return a?b.decodePathSegment(d):d}d=!1;"/"===a.charAt(0)&&(a=a.substring(1));a.match(/\.?\//)&&(d=!0);var e=RegExp(v(this.filename())+"$");a=b.recodePath(a);this._parts.path=this._parts.path.replace(e,a);d?this.normalizePath(c):this.build(!c);return this};e.suffix=function(a,c){if(this._parts.urn)return void 0===a?"":this;if(void 0===a||!0===a){if(!this._parts.path||"/"===this._parts.path)return"";var d=this.filename(),e=d.lastIndexOf(".");
if(-1===e)return"";d=d.substring(e+1);d=/^[a-z0-9%]+$/i.test(d)?d:"";return a?b.decodePathSegment(d):d}"."===a.charAt(0)&&(a=a.substring(1));if(d=this.suffix())e=a?RegExp(v(d)+"$"):RegExp(v("."+d)+"$");else{if(!a)return this;this._parts.path+="."+b.recodePath(a)}e&&(a=b.recodePath(a),this._parts.path=this._parts.path.replace(e,a));this.build(!c);return this};e.segment=function(a,c,d){var b=this._parts.urn?":":"/",e=this.path(),f="/"===e.substring(0,1),e=e.split(b);void 0!==a&&"number"!==typeof a&&
(d=c,c=a,a=void 0);if(void 0!==a&&"number"!==typeof a)throw Error("Bad segment '"+a+"', must be 0-based integer");f&&e.shift();0>a&&(a=Math.max(e.length+a,0));if(void 0===c)return void 0===a?e:e[a];if(null===a||void 0===e[a])if(t(c)){e=[];a=0;for(var k=c.length;a<k;a++)if(c[a].length||e.length&&e[e.length-1].length)e.length&&!e[e.length-1].length&&e.pop(),e.push(c[a])}else{if(c||"string"===typeof c)""===e[e.length-1]?e[e.length-1]=c:e.push(c)}else c||"string"===typeof c&&c.length?e[a]=c:e.splice(a,
1);f&&e.unshift("");return this.path(e.join(b),d)};e.segmentCoded=function(a,c,d){var e,f;"number"!==typeof a&&(d=c,c=a,a=void 0);if(void 0===c){a=this.segment(a,c,d);if(t(a))for(e=0,f=a.length;e<f;e++)a[e]=b.decode(a[e]);else a=void 0!==a?b.decode(a):void 0;return a}if(t(c))for(e=0,f=c.length;e<f;e++)c[e]=b.decode(c[e]);else c="string"===typeof c?b.encode(c):c;return this.segment(a,c,d)};var D=e.query;e.query=function(a,c){if(!0===a)return b.parseQuery(this._parts.query,this._parts.escapeQuerySpace);
if("function"===typeof a){var d=b.parseQuery(this._parts.query,this._parts.escapeQuerySpace),e=a.call(this,d);this._parts.query=b.buildQuery(e||d,this._parts.duplicateQueryParameters,this._parts.escapeQuerySpace);this.build(!c);return this}return void 0!==a&&"string"!==typeof a?(this._parts.query=b.buildQuery(a,this._parts.duplicateQueryParameters,this._parts.escapeQuerySpace),this.build(!c),this):D.call(this,a,c)};e.setQuery=function(a,c,d){var e=b.parseQuery(this._parts.query,this._parts.escapeQuerySpace);
if("object"===typeof a)for(var f in a)p.call(a,f)&&(e[f]=a[f]);else if("string"===typeof a)e[a]=void 0!==c?c:null;else throw new TypeError("URI.addQuery() accepts an object, string as the name parameter");this._parts.query=b.buildQuery(e,this._parts.duplicateQueryParameters,this._parts.escapeQuerySpace);"string"!==typeof a&&(d=c);this.build(!d);return this};e.addQuery=function(a,c,d){var e=b.parseQuery(this._parts.query,this._parts.escapeQuerySpace);b.addQuery(e,a,void 0===c?null:c);this._parts.query=
...
a._parts.hostname&&a._parts.path&&"/"!==a._parts.path.charAt(0)&&(c+="/");c+=a.path(!0);if(a._parts.query){for(var d="",e=0,k=a._parts.query.split("&"),r=k.length;e<r;e++){var g=(k[e]||"").split("="),d=d+("&"+b.decodeQuery(g[0],this._parts.escapeQuerySpace).replace(/&/g,"%26"));void 0!==g[1]&&(d+="="+b.decodeQuery(g[1],this._parts.escapeQuerySpace).replace(/&/g,"%26"))}c+="?"+d.substring(1)}return c+=b.decodeQuery(a.hash(),!0)};e.absoluteTo=function(a){var c=this.clone(),d=["protocol","username",
...
if(c.toString()===a.toString())return!0;d=c.query();e=a.query();c.query("");a.query("");if(c.toString()!==a.toString()||d.length!==e.length)return!1;d=b.parseQuery(d,this._parts.escapeQuerySpace);e=b.parseQuery(e,this._parts.escapeQuerySpace);for(k in d)if(p.call(d,k)){if(!t(d[k])){if(d[k]!==e[k])return!1}else if(!x(d[k],e[k]))return!1;f[k]=!0}for(k in e)if(p.call(e,k)&&!f[k])return!1;return!0};e.duplicateQueryParameters=function(a){this._parts.duplicateQueryParameters=!!a;return this};e.escapeQuerySpace=
function(a){this._parts.escapeQuerySpace=!!a;return this};return b});
(function(f,h){"object"===typeof exports?module.exports=h(require("./URI")):"function"===typeof define&&define.amd?define(["./URI"],h):f.URITemplate=h(f.URI,f)})(this,function(f,h){function g(b){if(g._cache[b])return g._cache[b];if(!(this instanceof g))return new g(b);this.expression=b;g._cache[b]=this;return this}function n(b){this.data=b;this.cache={}}var b=h&&h.URITemplate,v=Object.prototype.hasOwnProperty,q=g.prototype,t={"":{prefix:"",separator:",",named:!1,empty_name_separator:!1,encode:"encode"},
"+":{prefix:"",separator:",",named:!1,empty_name_separator:!1,encode:"encodeReserved"},"#":{prefix:"#",separator:",",named:!1,empty_name_separator:!1,encode:"encodeReserved"},".":{prefix:".",separator:".",named:!1,empty_name_separator:!1,encode:"encode"},"/":{prefix:"/",separator:"/",named:!1,empty_name_separator:!1,encode:"encode"},";":{prefix:";",separator:";",named:!0,empty_name_separator:!1,encode:"encode"},"?":{prefix:"?",separator:"&",named:!0,empty_name_separator:!0,encode:"encode"},"&":{prefix:"&",
separator:"&",named:!0,empty_name_separator:!0,encode:"encode"}};g._cache={};g.EXPRESSION_PATTERN=/\{([^a-zA-Z0-9%_]?)([^\}]+)(\}|$)/g;g.VARIABLE_PATTERN=/^([^*:]+)((\*)|:(\d+))?$/;g.VARIABLE_NAME_PATTERN=/[^a-zA-Z0-9%_]/;g.expand=function(b,f){var h=t[b.operator],k=h.named?"Named":"Unnamed",s=b.variables,e=[],p,l,w;for(w=0;l=s[w];w++)p=f.get(l.name),p.val.length?e.push(g["expand"+k](p,h,l.explode,l.explode&&h.separator||",",l.maxlength,l.name)):p.type&&e.push("");return e.length?h.prefix+e.join(h.separator):
""};g.expandNamed=function(b,g,h,k,s,e){var p="",l=g.encode;g=g.empty_name_separator;var w=!b[l].length,t=2===b.type?"":f[l](e),n,q,v;q=0;for(v=b.val.length;q<v;q++)s?(n=f[l](b.val[q][1].substring(0,s)),2===b.type&&(t=f[l](b.val[q][0].substring(0,s)))):w?(n=f[l](b.val[q][1]),2===b.type?(t=f[l](b.val[q][0]),b[l].push([t,n])):b[l].push([void 0,n])):(n=b[l][q][1],2===b.type&&(t=b[l][q][0])),p&&(p+=k),h?p+=t+(g||n?"=":"")+n:(q||(p+=f[l](e)+(g||n?"=":"")),2===b.type&&(p+=t+","),p+=n);return p};g.expandUnnamed=
function(b,g,h,k,s,e){e="";var p=g.encode;g=g.empty_name_separator;var l=!b[p].length,t,n,q,v;q=0;for(v=b.val.length;q<v;q++)s?n=f[p](b.val[q][1].substring(0,s)):l?(n=f[p](b.val[q][1]),b[p].push([2===b.type?f[p](b.val[q][0]):void 0,n])):n=b[p][q][1],e&&(e+=k),2===b.type&&(t=s?f[p](b.val[q][0].substring(0,s)):b[p][q][0],e+=t,e=h?e+(g||n?"=":""):e+","),e+=n;return e};g.noConflict=function(){h.URITemplate===g&&(h.URITemplate=b);return g};q.expand=function(b){var f="";this.parts&&this.parts.length||this.parse();
b instanceof n||(b=new n(b));for(var h=0,k=this.parts.length;h<k;h++)f+="string"===typeof this.parts[h]?this.parts[h]:g.expand(this.parts[h],b);return f};q.parse=function(){var b=this.expression,f=g.EXPRESSION_PATTERN,h=g.VARIABLE_PATTERN,k=g.VARIABLE_NAME_PATTERN,s=[],e=0,p,l,n;for(f.lastIndex=0;;){l=f.exec(b);if(null===l){s.push(b.substring(e));break}else s.push(b.substring(e,l.index)),e=l.index+l[0].length;if(!t[l[1]])throw Error('Unknown Operator "'+l[1]+'" in "'+l[0]+'"');if(!l[3])throw Error('Unclosed Expression "'+
l[0]+'"');p=l[2].split(",");for(var q=0,v=p.length;q<v;q++){n=p[q].match(h);if(null===n)throw Error('Invalid Variable "'+p[q]+'" in "'+l[0]+'"');if(n[1].match(k))throw Error('Invalid Variable Name "'+n[1]+'" in "'+l[0]+'"');p[q]={name:n[1],explode:!!n[3],maxlength:n[4]&&parseInt(n[4],10)}}if(!p.length)throw Error('Expression Missing Variable(s) "'+l[0]+'"');s.push({expression:l[0],operator:l[1],variables:p})}s.length||s.push(b);this.parts=s;return this};n.prototype.get=function(b){var f=this.data,
...
(function(f,h){"object"===typeof exports?module.exports=h(require("jquery","./URI")):"function"===typeof define&&define.amd?define(["jquery","./URI"],h):h(f.jQuery,f.URI)})(this,function(f,h){function g(b){return b.replace(/([.*+?^=!:${}()|[\]\/\\])/g,"\\$1")}function n(b){var f=b.nodeName.toLowerCase();return"input"===f&&"image"!==b.type?void 0:h.domAttributes[f]}function b(b){return{get:function(g){return f(g).uri()[b]()},set:function(g,e){f(g).uri()[b](e);return e}}}function v(b,g){var e,h,l;if(!n(b)||
!g)return!1;e=g.match(z);if(!e||!e[5]&&":"!==e[2]&&!t[e[2]])return!1;l=f(b).uri();if(e[5])return l.is(e[5]);if(":"===e[2])return h=e[1].toLowerCase()+":",t[h]?t[h](l,e[4]):!1;h=e[1].toLowerCase();return q[h]?t[e[2]](l[h](),e[4],h):!1}var q={},t={"=":function(b,f){return b===f},"^=":function(b,f,e){return!!(b+"").match(RegExp("^"+g(f),"i"))},"$=":function(b,f,e){return!!(b+"").match(RegExp(g(f)+"$","i"))},"*=":function(b,f,e){"directory"==e&&(b+="/");return!!(b+"").match(RegExp(g(f),"i"))},"equals:":function(b,
f){return b.equals(f)},"is:":function(b,f){return b.is(f)}};f.each("authority directory domain filename fragment hash host hostname href password path pathname port protocol query resource scheme search subdomain suffix tld username".split(" "),function(g,h){q[h]=!0;f.attrHooks["uri:"+h]=b(h)});var r=function(b,g){return f(b).uri().href(g).toString()};f.each(["src","href","action","uri","cite"],function(b,g){f.attrHooks[g]={set:r}});f.attrHooks.uri.get=function(b){return f(b).uri()};f.fn.uri=function(b){var f=
...
this._string),this._dom_element[this._dom_attribute]=this._string;else if(!0===b)this._deferred_build=!0;else if(void 0===b||this._deferred_build)this._string=h.build(this._parts),this._deferred_build=!1;return this};var x,z=/^([a-zA-Z]+)\s*([\^\$*]?=|:)\s*(['"]?)(.+)\3|^\s*([a-zA-Z0-9]+)\s*$/;x=f.expr.createPseudo?f.expr.createPseudo(function(b){return function(f){return v(f,b)}}):function(b,f,e){return v(b,e[3])};f.expr[":"].uri=x;return{}});
;/**
...
Settings.setup();;var applicationRoot = './';
...
var populateCategories = function() {
    ...
    category_html += '<li'+ (defaultCategory == 'all' ? ' class="active" ' : '') +'>'+
...
jQuery(function ($) {
  ...
  $('#catalog-select ul li a').on('click', function (evt) {
    ...
    if (genre == 'all') {
      ...
      App.Router.navigate('filter/' + genre, { trigger: fals });
    }
    evt.preventDefault();
  });
...
})(window, _, Q);;/*var request = require('request')
...
;App.currentScrapper = App.Scrapers.Yts;;App.View.Page = Backbone.View.extend({
    className: 'page',
